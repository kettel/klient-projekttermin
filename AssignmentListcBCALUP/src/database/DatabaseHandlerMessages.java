...
public class DatabaseHandlerMessages extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		String CREATE_MESSAGES_TABLE = "CREATE TABLE " + TABLE_MESSAGES + "("
				+ KEY_ID + " INTEGER PRIMARY KEY," + KEY_MESSAGE_CONTENT
				+ " TEXT," + KEY_RECEIVER + " TEXT," + KEY_MESSAGE_TIMESTAMP
				+ " TEXT," + KEY_IS_READ + " TEXT" + ")";
	 ...
	 * 
	 * @param Contact
	 *            Den kontakt som ska läggas till i databasen
	 */
	public void addMessage(MessageModel message) {
		...
		values.put(KEY_MESSAGE_TIMESTAMP,
	...
	/**
	 * Returnerar alla meddelanden i en Array-lista. Meddelanden har nu ett ID
	 * från databasen.
	 * 
	 * @return
	 */
		...
		if (cursor.moveToFirst()) {
			do {
				...
				MessageModel message = new MessageModel(Long.valueOf(cursor
						...
						cursor.getString(2), Long.valueOf(cursor.getString(3)),
